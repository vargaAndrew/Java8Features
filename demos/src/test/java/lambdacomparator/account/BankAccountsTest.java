...
class BankAccountsTest {
    ...
    void testListBankAccountsByNameThanAccountNumber() {
        ...
        assertEquals(null, sorted.get(0).getOwnerName());
        assertEquals("Ábrahám Doe", sorted.get(1).getOwnerName());
        assertEquals("Alphonse Doe", sorted.get(2).getOwnerName());
        assertEquals("John Doe", sorted.get(4).getOwnerName());
